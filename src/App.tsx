      ...
      <ProgressIndicator>
        {PAGE_BY_STEP.map((pageName, index) => {
          if (index <= store.currentStep) {
            return (
              <li key={pageName} className="active">
        ...
        >
          <div className="route__container">
            <Switch location={location}>
              <Route
                path="/Name"
                component={renderComponent(FullNameFormPage)}
              />
              <Route path="/Email" component={renderComponent(EmailFormPage)} />
              <Route
                path="/Phone"
                component={renderComponent(PhoneNumberFormPage)}
              />
              <Route
                path="/Salary"
                component={renderComponent(SalaryIndicatorFormPage)}
              />
